...
# TODO fix
# def test_build_no_yml(monkeypatch: Any, capsys: Any):
#     files_path = copy_to_output(AUDIOBOOK_MP3_ONLY_FILES)
#     output_temp = Path(f"{OUTPUT_PATH}/audiobook").resolve()
#     utils.remove_directory(output_temp)
...
#     assert reader.tags.title == "Audio Album"
#     assert reader.tags.album == "Audio Series 01: Audio Album"
